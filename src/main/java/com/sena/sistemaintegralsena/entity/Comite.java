...
public class Comite {
    ...
    // ❌ Se eliminó @FutureOrPresent para permitir la validación personalizada del día 20
    private LocalDate fecha;

    @NotNull(message = "Horario permitido: 9:00 AM - 5:00 PM.")
    ...
    @DateTimeFormat(pattern = "yyyy-MM-dd")
    private LocalDate fechaPlazo; // Se calcula automáticamente
